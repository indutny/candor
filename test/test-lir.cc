...
TEST_START(lir)
  ...
  LIR_TEST("if (true) { a = 1 } else { a = 2}\nreturn a\n",
           ...
           "18: Label\n"
           "20: r8:rax = Literal[2]\n"
           "22: r7:rax = Move r8:rax\n"
           "\n"
           "# Block 3\n"
           "# in: 7, out: \n"
           "26: Label\n"
           "28: r6:rax = Phi r7:rax\n"
           "30: @r0:rax = Move r6:rax\n"
           "32: Return @r0:rax\n\n")
  ...
  LIR_TEST("pass_through = 1\n"
           ...
           "4: r4:rcx = Literal[1]\n"
           "6: r5:rax = Nil\n"
           "8: r7:rax = Move r5:rax\n"
           "\n"
           "# Block 1\n"
           "# in: 7, 4, out: 6, 4\n"
           "12: Label\n"
           "14: r6:rdx = Phi r7:rax\n"
           "\n"
           "# Block 2\n"
           "# in: 6, 4, out: 6, 4\n"
           "18: Label\n"
           ...
           "24: @r0:rax = Move r6:rdx\n"
           "25: Gap[r4:rcx => s13:1, r6:rdx => s15:2]\n"
           ...
           "38: @r1:rbx = Move r10:rax\n"
           "40: @r0:rax = Move s15:2\n"
           ...
           "# in: 4, 6, out: \n"
           "58: Label\n"
           "60: @r1:rbx = Move s13:1\n"
           "62: @r0:rax = Move s15:2\n"
