...
TEST_START(hir)
  ...
  HIR_TEST("if (a) { a = 2 } else { if (a) { a = 3 } else { a = 4 } }\n"
           ...
           "[Block#2\n"
           "12: [Nop *[0 [st:0]]]\n"
           "14: [BranchBool *[0 [st:0]]]\n"
           "[0]>*>[4,5]]\n\n"

           "[Block#4\n"
           "16: *[3 [imm 0x6]] = [LoadRoot]\n"
           "18: *[4 [st:0]] = [StoreLocal *[3 [imm 0x6]]]\n"
           "20: [Goto]\n"
           "[2]>*>[6]]\n\n"

           "[Block#5\n"
           "22: *[5 [imm 0x8]] = [LoadRoot]\n"
           "24: *[6 [st:0]] = [StoreLocal *[5 [imm 0x8]]]\n"
           "26: [Goto]\n"
           "[2]>*>[6]]\n\n"
  ...
  HIR_TEST("a = 0\nwhile (true) { b = a\na = 2 }\nreturn a",
           ...
           "[Block#2\n"
           "10: *[3 [ctx -2:11]] = [LoadRoot]\n"
           "12: [BranchBool *[3 [ctx -2:11]]]\n"
           "[1]>*>[3,4]]\n\n"

           "[Block#3\n"
           "14: [Nop *[2 [st:0]]]\n"
           "16: *[4 [st:1]] = [StoreLocal *[2 [st:0]]]\n"
           "18: *[5 [imm 0x4]] = [LoadRoot]\n"
           "20: *[6 [st:0]] = [StoreLocal *[5 [imm 0x4]]]\n"
           "22: [Goto]\n"
           "[2]>*>[1]]\n\n"
