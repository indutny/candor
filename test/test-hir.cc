...
TEST_START(hir)
  ...
  HIR_TEST("a = 1\nb = 1",
           ...
           "[Entry] "
           "[LoadRoot *[0 [reg 0x2]]] "
           "[StoreLocal *[1 [st:0]] *[0 [reg 0x2]]] "
           "[LoadRoot *[2 [reg 0x2]]] "
           "[StoreLocal *[3 [st:1]] *[2 [reg 0x2]]] "
           "[Return *[4 [reg 0x1]]] "
           "[]>*>[]]\n")
  HIR_TEST("a = 2\na = a",
           "[Block#0 {0,2,3} "
