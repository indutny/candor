...
TEST_START(hir)
  ...
  HIR_TEST("i = 0\nwhile(++i) { }\nreturn i",
           ...
           "[Block#2 {3,5||3,5} [BranchBool *[3 [st:-1]]] [1]>*>[3,4]]\n"

           "[Block#3 {3,5||3,5} [Goto] [2]>*>[1]]\n"
  ...
  HIR_TEST("i = 0\nwhile(nil) { while(nil) { i = i + 1 } }\nreturn i",
           ...
           "[Block#1 {5,8||5,8} @[1,7]:8 "
           "[LoadRoot *[2 [imm 0x1]]] [Goto] [0,8]>*>[2]]\n"

           "[Block#2 {5,8||5,8} [BranchBool *[2 [imm 0x1]]] [1]>*>[3,4]]\n"
           "[Block#3 {5,8||5,8} [Goto] [2]>*>[5]]\n"

           "[Block#5 {5,7||7,5} @[1,8]:7 "
           "[LoadRoot *[3 [imm 0x1]]] "
           "[Goto] [3,7]>*>[6]]\n"

           "[Block#6 {5,7||7,5} [BranchBool *[3 [imm 0x1]]] [5]>*>[7,8]]\n"

           "[Block#7 {5,7||7,5} "
           "[LoadLocal *[7 [st:0]]] "
           "[LoadRoot *[4 [imm 0x2]]] "
           "[BinOp *[7 [st:0]] *[4 [imm 0x2]] *[5 [st:-1]]] "
           "[StoreLocal *[1>6 [st:0]] *[5 [st:-1]]] "
           "[Goto] [6]>*>[5]]\n"

           "[Block#8 {5,7||7,5} [Goto] [6]>*>[1]]\n"
