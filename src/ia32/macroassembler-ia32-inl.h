#ifndef _SRC_IA32_MARCOASSEMBLER_INL_H_
#define _SRC_IA32_MARCOASSEMBLER_INL_H_

#include "macroassembler-ia32.h"
...
inline void Masm::SpillSlot(uint32_t index, Operand& op) {
  op.base(ebp);
  op.disp(-spill_offset_ - 4 * index);
}

} // namespace internal
} // namespace candor

#endif // _SRC_IA32_MARCOASSEMBLER_INL_H_
